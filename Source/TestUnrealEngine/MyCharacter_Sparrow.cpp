...
AMyCharacter_Sparrow::AMyCharacter_Sparrow()
{
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> SM(TEXT("SkeletalMesh'/Game/ParagonSparrow/Characters/Heroes/Sparrow/Meshes/Sparrow.Sparrow'"));
...
void AMyCharacter_Sparrow::BeginPlay()
{
	...
	{
		DefaultScriptActor->OnKillDusk.AddUObject(this, &AMyCharacter_Sparrow::CatchDusk);
		DefaultScriptActor->OnKillDown.AddUObject(this, &AMyCharacter_Sparrow::CatchDown);
		DefaultScriptActor->OnKillBuff.AddUObject(this, &AMyCharacter_Sparrow::CatchWhite);
	}
}
...
void AMyCharacter_Sparrow::Tick(float DeltaTime)
{
	...
	if (AttackRMove)
	{
		FVector NewLocation1 = GetActorLocation() + GetActorForwardVector() * 10.f;
...
void AMyCharacter_Sparrow::ArrowZoomIn()
{
	...
	FRotator r = FRotator(30.f, 0.f, 0.f);
	Camera->SetRelativeRotation(r);
...
void AMyCharacter_Sparrow::RefreshUI()
{
...
void AMyCharacter_Sparrow::CatchDusk()
{
	TArray<AActor*> Gates;
...
void AMyCharacter_Sparrow::CatchDown()
{
	TArray<AActor*> Gates;
...
void AMyCharacter_Sparrow::CatchWhite()
{
	TArray<AActor*> Gates;
