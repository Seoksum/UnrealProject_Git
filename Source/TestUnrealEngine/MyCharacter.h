...
UCLASS()
class TESTUNREALENGINE_API AMyCharacter : public ACharacter, public IHealthInterface
{
	GENERATED_BODY()
...
public:	
	...
	FHitResult AttackCollisionCheckBySweep();

	TArray<FHitResult> AttackCheckBySphereTrace(float AttackRange, float AttackRadius, FVector Loc);
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	class UParticleSystem* AttackR_Effect;
