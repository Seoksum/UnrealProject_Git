...
public class TestUnrealEngine : ModuleRules
{
	public TestUnrealEngine(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore","UMG","NavigationSystem","AIModule","GameplayTasks","Slate","SlateCore", "LevelSequence","MovieScene" });
